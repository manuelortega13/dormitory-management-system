...
router.get('/pending-admin', authMiddleware, roleMiddleware('admin'), leaveRequestController.getPendingAdmin);
...
// POST /api/leave-requests/:id/admin-approve - Admin approves request
router.post('/:id/admin-approve', authMiddleware, roleMiddleware('admin'), leaveRequestController.adminApprove);

// POST /api/leave-requests/:id/admin-decline - Admin declines request
router.post('/:id/admin-decline', authMiddleware, roleMiddleware('admin'), leaveRequestController.adminDecline);
